...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    private static let zhHans: [String: String] = [
        ...
        "Error-log support will be retried when this drive is available.": "此磁盘可用时将重新尝试错误日志支持检测。",
        ...
        "Disk Refresh": "磁盘刷新",
        "Automatic disk refresh": "自动刷新磁盘",
        "Periodically rescans connected disks and refreshes SMART data. Disk connection and removal events always refresh automatically.": "按所选间隔重新扫描已连接磁盘并刷新 SMART 数据。磁盘接入和移除事件始终会自动触发刷新。",
        ...
        "This applies only when Capricorn starts. Switching a volume from Disk Actions takes effect immediately.": "此设置仅在 Capricorn 启动时生效。在“磁盘操作”中切换卷宗会立即生效。",
        "Switch Volume": "切换卷宗",
        "System Volume": "系统卷宗",
