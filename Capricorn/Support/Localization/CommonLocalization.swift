...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    private static let zhHans: [String: String] = [
        ...
        "This permanently removes all SMART, benchmark, and live-activity history from the current database. It cannot be undone.": "这会永久删除当前数据库中的所有 SMART、测速和实时活动历史记录，且无法撤销。",
