...
final class CapricornTests: XCTestCase {
    ...
    func testExternalDriveModelCatalogIdentifiesARRICodexRecordingMedia() throws {
        let cases: [(reportedModel: String, recordID: String, marketingName: String)] = [
            ("CDXCDC0192M300N40A", "arri-codex-compact-drive", "Codex Compact Drive 2TB"),
            ("CDXCDC0096M300N40A", "arri-codex-compact-drive", "Codex Compact Drive 1TB"),
            ("CX.0001090", "arri-codex-compact-drive-express", "Codex Compact Drive Express 1TB"),
            ("CDX-37019/18", "arri-codex-sxr-capture-drive", "Codex SXR Capture Drive 1TB"),
            ("CDX-37021/20", "arri-codex-sxr-capture-drive", "Codex SXR Capture Drive 2TB")
        ]

        for testCase in cases {
            let drive = Self.externalCatalogDrive(model: testCase.reportedModel, protocolName: "PCI-Express")
            let match = try XCTUnwrap(ExternalDriveModelCatalog.bundled.match(for: drive), testCase.reportedModel)
            ...
            XCTAssertEqual(drive.catalogDisplayName, testCase.marketingName)
            XCTAssertEqual(drive.catalogSidebarDisplayName, testCase.marketingName)
            XCTAssertEqual(
                drive.catalogDisplayHelp(language: .simplifiedChinese),
                "\(testCase.marketingName)\n原始型号: \(testCase.reportedModel)"
            )
        }
    }
    ...
    func testExternalDriveModelCatalogIdentifiesExpandedConsumerOEMAndDataCenterFamilies() throws {
        let cases: [(reportedModel: String, protocolName: String, recordID: String, marketingName: String)] = [
            ("INTEL SSDPE2NV076T801", "PCI-Express", "intel-solidigm-d5-p4320", "Intel/Solidigm D5-P4320 7.68TB"),
            ("INTEL SSDPE2NV153T801", "PCI-Express", "intel-solidigm-d5-p4326", "Intel/Solidigm D5-P4326 15.36TB"),
            ("INTEL SSDPE2NU076T801", "PCI-Express", "intel-solidigm-d5-p4420", "Intel/Solidigm D5-P4420 7.68TB"),
            ("INTEL SSDPE2KX020T801", "PCI-Express", "intel-solidigm-d7-p4510", "Intel/Solidigm D7-P4510 2TB"),
            ("INTEL SSDPELKX020T801", "PCI-Express", "intel-solidigm-d7-p4511", "Intel/Solidigm D7-P4511 2TB"),
            ("INTEL SSDPE2KE064T801", "PCI-Express", "intel-solidigm-d7-p4610", "Intel/Solidigm D7-P4610 6.4TB"),
            ("SOLIDIGM SSDPF2SQ016TZ01", "PCI-Express", "solidigm-d7-p5810", "Solidigm D7-P5810 1.6TB"),
            ("SOLIDIGM SBFPF2BU307T001", "PCI-Express", "solidigm-d5-p5430", "Solidigm D5-P5430 30.72TB"),
            ("SOLIDIGM SBFPF2BV0P12001", "PCI-Express", "solidigm-d5-p5336", "Solidigm D5-P5336 122.88TB"),
            ("SOLIDIGM SB5PH27X076T001", "PCI-Express", "solidigm-d7-ps1010", "Solidigm D7-PS1010 7.68TB"),
            ("SOLIDIGM SB5PH27E128T001", "PCI-Express", "solidigm-d7-ps1030", "Solidigm D7-PS1030 12.8TB"),
            ("SOLIDIGM SSDPF2KX076T11Z", "PCI-Express", "solidigm-d7-p5520", "Solidigm D7-P5520 7.68TB"),
            ("SOLIDIGM SSDPFWKX153T1N1", "PCI-Express", "solidigm-d7-p5520", "Solidigm D7-P5520 15.36TB"),
            ("SSDPF2KE128T11Z", "PCI-Express", "solidigm-d7-p5620", "Solidigm D7-P5620 12.8TB"),
            ("SSDPF2KE128T1N1", "PCI-Express", "solidigm-d7-p5620", "Solidigm D7-P5620 12.8TB"),
            ("SOLIDIGM SSDPFWNV307TZN1", "PCI-Express", "solidigm-d5-p5316", "Solidigm D5-P5316 30.72TB"),
            ...
            ("WDC WUS4BB038D7P3E5", "PCI-Express", "wd-ultrastar-sn640", "WD Ultrastar DC SN640 3.84TB"),
    ...
    func testSATDriverGuidanceSMARTMessagesUseUnpunctuatedLines() {
        ...
        XCTAssertFalse(SATSMARTDriverGuidance.installationSuggested.keepsMessageLinesSingleLine)
        XCTAssertFalse(SATSMARTDriverGuidance.activationRequired.keepsMessageLinesSingleLine)
        XCTAssertTrue(SATSMARTDriverGuidance.samsungT5DriverConflict.keepsMessageLinesSingleLine)
        XCTAssertTrue(SATSMARTDriverGuidance.usbNVMeSMARTUnavailable.keepsMessageLinesSingleLine)
    }
    ...
    func testSATDriverGuidanceExplainsSamsungT5ConflictAndUSBConnectedNVMeLimits() {
        ...
        XCTAssertEqual(
            SATSMARTDriverGuidancePolicy.guidance(for: catalogT5, snapshot: unavailable, driverStatus: notInstalled),
            .installationSuggested
        )
        XCTAssertEqual(
